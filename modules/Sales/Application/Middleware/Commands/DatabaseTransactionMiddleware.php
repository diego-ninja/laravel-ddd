...
namespace Modules\Sales\Application\Middleware\Commands;
...
class DatabaseTransactionMiddleware
{
    ...
    private function ensureUserIsAuthorized(object $command): void
    {
        ...
        // Example:
        // if (!auth()->check()) {
        //     throw SalesDomainException::businessRuleViolation('User must be authenticated');
        // }
        //
        // if (!auth()->user()->can('execute', $command)) {
        //     throw SalesDomainException::businessRuleViolation('User not authorized for this action');
        // }
    }
    ...
    private function checkRateLimit(object $command): void
    {
        ...
        //     throw SalesDomainException::businessRuleViolation('Too many attempts');
        // }
        // 
